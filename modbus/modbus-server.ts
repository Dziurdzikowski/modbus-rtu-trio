...
export default class ModbusServer extends EventEmitter {
  ...
  public on (event: 'preWriteSingleRegister', listener: (request: ModbusAbstractRequest<WriteSingleRegisterRequestBody>, cb: BufferCB) => void): this
  ...
  public emit (event: 'data', data: any): boolean
