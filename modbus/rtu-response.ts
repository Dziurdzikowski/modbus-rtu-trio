...
export default class ModbusRTUResponse<ResBody extends ModbusResponseBody = ModbusResponseBody>
  ...
  public static fromRequest<ReqBody extends ModbusRequestBody, ResBody extends ModbusResponseBody> (
    rtuRequest: (ModbusAbstractRequest<ReqBody> | ModbusRTURequest<ReqBody>),
    modbusBody: ResBody
  ): (ModbusAbstractResponse<ResBody> | ModbusRTUResponse<ResBody>) {
...
export type ModbusRTUResponseFromRequest = <ReqBody extends ModbusRequestBody, ResBody extends ModbusResponseBody> (
